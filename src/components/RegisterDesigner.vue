<template>
  <div class="reg-container">
    <div class="login-box">
      <h4>Sign Up for Designer</h4>
      <hr />
      <p>
        Register with your MDIS Membership ID and Email. Learn more about
        <a href="https://www.mdis.edu.sg/membership-types" target="_blank">MDIS Membership</a>.
        <br />Or, Just become a
        <router-link :to="{name: 'Register'}">Website Member</router-link>
      </p>
      <form class="form-group">
        <div class="input-field text-justify">
          <label for="d_username">Username*</label>
          <input id="d_username" type="text" class="form-control" v-model="d_username" required />
        </div>
        <div class="input-field text-justify">
          <label for="d_email">Email*</label>
          <input id="d_email" type="email" class="form-control" v-model="d_email" required />
        </div>
        <div class="input-field text-justify">
          <label for="d_password">Password*</label>
          <input id="d_password" type="password" class="form-control" v-model="d_password" required />
        </div>
        <div class="input-field text-justify">
          <label for="d_password_confirm">Confirm Password*</label>
          <input
            id="d_password_confirm"
            type="password"
            class="form-control"
            v-model="d_password_confirm"
            required
          />
        </div>
        <div class="input-field text-justify">
          <div class="agree-terms">
            <input class="agree-terms-checkbox" type="checkbox" id="checkbox" v-model="d_checked" />
            <label for="checkbox">
        ...
        <div class="center-align">
          <hr />
          <button v-on:click="register(1)" class="btn btn-primary btn-large">Register</button>
        </div>
      </form>
    </div>
  </div>
